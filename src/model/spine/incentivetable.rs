...
pub struct IncentiveTableElementsType {
  ...
  #[serde(skip_serializing_if = "Option::is_none")]
  pub incentive_slot: Option<IncentiveTableIncentiveSlotElementsType>,
}
...
pub struct IncentiveTableIncentiveSlotElementsType {
  ...
  #[serde(skip_serializing_if = "Option::is_none")]
  pub tier: Option<IncentiveTableTierElementsType>,
}
...
pub struct IncentiveTableDescriptionTierElementsType {
  ...
  #[serde(skip_serializing_if = "Option::is_none")]
  pub boundary_description: Option<tariffinformation::TierBoundaryDescriptionDataElementsType>,
  #[serde(skip_serializing_if = "Option::is_none")]
  pub incentive_description: Option<tariffinformation::IncentiveDescriptionDataElementsType>,
}
...
pub struct IncentiveTableDescriptionDataType {
	#[serde(skip_serializing_if = "Option::is_none")]
  pub incentive_table_description: Option<IncentiveTableDescriptionType>,
}
